...
<script type="text/javascript" charset="utf-8" src="${ctx}/resources/js/adddate.js"></script>
...
<script src="${ctx}/resources/zui/lib/datatable/zui.datatable.min.js"></script>