...
<body>
	...
	<form:form modelAttribute="chargeitem" id="chargeitem" method="post">
		<div class="panel panel-info" style="width: 99%">
			<div class="panel-body">
				<table class="table table-condensed">
					<tr height="40px">
						<td width="220px" align="right"><span class="err">*</span>收费项目:</td>
						<td width="320px">
						
						<form:input path="ItemName" id="expertName"
								cssClass="form-control" style="width:320px" />
								<span id="expertNameErr" class="err"></span></td>
					</tr>
					
					<tr height="40px">
						<td width="220px" align="right"><span class="err">*</span>收费金额:</td>
						<td width="320px">
						
						<form:input path="Amount" id="Amount"
								cssClass="form-control" style="width:320px" />
								<span id="Amount" class="err"></span></td>
					</tr>
					...
					<tr height="40px">
						<td width="220px" align="right"><span class="err">*</span>收费周期:</td>
						<td width="320px">
					
						
		
						
			            <form:select path="Periodic" id="periodic" onchange=""
							cssClass="form-control" style="width:320px">
							<form:option value="-1">请选择</form:option>
							<c:forEach items="${Periodic}" var="periodic">
								<form:option value="${periodic.name}">${periodic.displayName}</form:option>
							</c:forEach>
						</form:select>
					...
					<tr height="40px">
						<td width="220px" align="right"><span class="err">*</span>小票等级:</td>
						<td width="320px">
					
						
		
			
					          <form:select path="TicketLevel" id="TicketLevel" onchange=""
							cssClass="form-control" style="width:320px">
							<form:option value="-1">请选择</form:option>
							<c:forEach items="${TicketLevel}" var="TicketLevel">
								<form:option value="${TicketLevel.name}">${TicketLevel.displayName}</form:option>
							</c:forEach>
						</form:select><span id="TicketLevel" class="err"></span>
	                    <span id="TicketLevel" class="err"></span>
