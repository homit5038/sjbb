...
<script type="text/javascript">
	...
	function submitForm() {
		...
		var phone = $("#phone").val();
		var photoDir = $("#photoDir").val();
	
		var email = $("#email").val();
		var pgjg = $("#pgjg").val();
		if (expertName.length==0) {
			$("#expertNameErr").html("请填写专家姓名的");
			return false;
		}
		//if (photoDir.length==0) {
			//$("#photoDirErr").html("请填写dddd姓名的");
			//return false;
		//}
		$("#expertForm").submit();
	}  
...
<body>
	<c:if test="${msg!='edit' }"><pre>年级》新增年级&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" onclick="importData();" class="btn btn-link">导入</button></pre></c:if>
	<c:if test="${msg=='edit' }"><pre>年级》修改年级信息</pre></c:if>
	
	<form:form modelAttribute="grade" id="expertForm" method="post" enctype="multipart/form-data">
		<div class="panel panel-info" style="width: 99%">
			<div class="panel-body">
				<table class="table table-condensed">
					<tr height="40px">
						<td width="220px" align="right"><span class="err">*</span>年级名称:</td>
						<td width="320px"><form:input path="gradename" id="expertName"
								cssClass="form-control" style="width:320px" />
								<span id="expertNameErr" class="err"></span></td>
					</tr>
					<tr height="40px">
						<td width="220px" align="right"><span class="err">*</span>收费项关联:</td>
						<td width="320px"><form:input path="chargeitem" id="chargeitem"
								cssClass="form-control" style="width:320px" />
								<span id="expertNameErr" class="err"></span></td>
					</tr>	
					<tr height="40px">
						<td width="220px" align="right"><span class="err">*</span>号码:</td>
						<td width="320px"><form:input path="numbedr" id="numbedr"
								cssClass="form-control" style="width:320px" />
								<span id="numbedr" class="err"></span></td>
					</tr>	
					
					<tr height="40px">
						<td width="220px" align="right"><span class="err">*</span>头像:</td>
						<td width="320px">
						
	<input type="file" id="photoDir" class="form-control" style="width: 300px" name="photopath"/>
								<span id="photoDirErr" class="err"></span>
								<img src="${ctx}/grade/${grade.id}/getPic" width="40" height="40">
