...
<script type="text/javascript">
	...
	$("#charge-item-table").datatable({
	    ...
	    fnRowCallback : function(nRow,aData,iDataIndex){ 
	    	var watchId=aData.watchId; var html = '<input type="radio" name="radio" onclick="selectUser(\'' +watchId+ '\');">'; $('td:eq(0)', nRow).html(html); return nRow; }
	});
