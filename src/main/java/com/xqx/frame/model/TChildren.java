...
/*@JsonIgnoreProperties({"grade","classe"})*/
public class TChildren extends BaseAuditEntity {
    ...
    public Object getChargList() {
        return chargList;
    }

    public void setChargList(Object chargList) {
        this.chargList = chargList;
    }

    public Object getGropObject() {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("gradeId",this.grade.getId());
        map.put("classeId",this.classe.getId());
        return map;
    }
...
//        UserDetails u =  SecurityUtil.getCurrentUserName();
System.out.println("--------------98888818888---------------------------");
        if (isCreate) {
            setCreateTime(now);
